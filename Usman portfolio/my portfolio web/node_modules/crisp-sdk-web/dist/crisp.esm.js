...
var CrispUser = /** @class */ (function () {
    ...
    CrispUser.prototype.setCompany = function (name, data) {
        ...
        if (data === null || data === void 0 ? void 0 : data.employment) {
            payload.employment = [
                data.employment.title,
                data.employment.role
            ];
        }
        if (data === null || data === void 0 ? void 0 : data.geolocation) {
 ...
 */
var CrispScenario = /** @class */ (function () {
    /**
     * Constructor
     */
    function CrispScenario(crisp) {
        this.parent = crisp;
    }
    /**
     * Runs a bot scenario by name, with optional template variables
     */
    CrispScenario.prototype.run = function (name, variables) {
        this.parent.createSingletonIfNecessary();
...
var CrispSession = /** @class */ (function () {
    ...
    CrispSession.prototype.setData = function (data) {
        ...
        Object.entries(data).forEach(function (item) {
            if (_this.isValidDataValue(item[1])) {
...
var CrispChat = /** @class */ (function () {
     ...
     */
    CrispChat.prototype.setOverlayView = function (callback) {
        this.parent.createSingletonIfNecessary();
 ...
 * CONSTANTS
 ***************************************************************************/
var TOOL_EVENT_PREFIX = "hugo:tool:";
/**************************************************************************
 * CLASS
 ***************************************************************************/
/**
 ...
 */
var CrispHugo = /** @class */ (function () {
    /**
     * Constructor
     */
    function CrispHugo(crisp) {
        this.parent = crisp;
    }
    /**
     * Registers a handler for a Hugo Widget Tool
     */
    CrispHugo.prototype.onTool = function (name, handler) {
        this.parent.createSingletonIfNecessary();
        this.offTool(name);
        window.$crisp.push(["on", "".concat(TOOL_EVENT_PREFIX).concat(name), handler]);
    };
    /**
     * Unregisters a previously registered Hugo Widget Tool handler
     */
    CrispHugo.prototype.offTool = function (name) {
        this.parent.createSingletonIfNecessary();
        window.$crisp.push(["off", "".concat(TOOL_EVENT_PREFIX).concat(name)]);
    };
    return CrispHugo;
}());
...
var Crisp = /** @class */ (function () {
    ...
    Crisp.prototype.isCrispInjected = function () {
        var _a;
        if (this.injected === true || ((_a = window.$crisp) === null || _a === void 0 ? void 0 : _a.is)) {
            return true;
        }
        return false;
    };
